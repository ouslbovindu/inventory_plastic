...
const AssetAdjustmentModal: React.FC<AssetAdjustmentModalProps> = ({ 
  isOpen, 
  onClose, 
  onAdjust, 
  asset 
  ...
  useEffect(() => {
    if (asset) {
      setNewQuantity(asset.quantityNumeric);
  ...
  const quantityDifference = newQuantity - asset.quantityNumeric;
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">{asset.itemName}</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="bg-gray-50 p-3 rounded-lg">
            <div className="flex justify-between items-center">
              ...
              <span className="text-base font-bold text-gray-900">{asset.quantityNumeric}</span>
            </div>
          </div>
...
export default AssetAdjustmentModal;